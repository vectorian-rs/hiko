You are reviewing `docs/project/whitepaper.md` in the Hiko repository.
...
Read only enough context to verify claims in `docs/project/whitepaper.md`, especially from:
