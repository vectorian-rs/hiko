...
| [`docs-reorganization-2026-05-26.md`](docs-reorganization-2026-05-26.md) | Change summary                 | Summary of the 2026-05-26 docs folder reorganization, navigation improvements, path fixes, and validation.                                                                     |
...
| [`../prompts/language-evaluation-prompt.md`](../prompts/language-evaluation-prompt.md) | Reusable prompt                | Prompt for skeptical grading of Hiko correctness, performance, and safety.                                                                                                     |
