---- MODULE WaitAnyNotifierBroken ----
\* # Documentation
\*
\* ## Why this spec exists
\*
\* This is an intentionally broken negative-check model for Hiko's deterministic
...
\* that behavior executable and cheap to check. This spec intentionally delivers the notifier rather than the leftmost completed child. The checker must reject it; if it passes, the negative test is no longer useful.
